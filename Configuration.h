...
#define STRING_CONFIG_H_AUTHOR "(Marius A, Micromake D1)" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 "Marlin v1.1.9" // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "Kosselworks"         // will be shown during bootup in line 2
...
#define CUSTOM_MACHINE_NAME "flakaflaka yoyo"
...
#define DELTA_HEIGHT 294.01 // get this value from auto calibrate

#define DELTA_ENDSTOP_ADJ { 0.0, -2.01, -0.34 } // get these from auto calibrate

// Horizontal distance bridged by diagonal push rods when effector is centered.
#define DELTA_RADIUS 111.60 //mm  Get this value from auto calibrate

// Trim adjustments for individual towers
// tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
// measured in degrees anticlockwise looking from above the printer
#define DELTA_TOWER_ANGLE_TRIM { 0.00, -0.35, 0.35 } // get these values from auto calibrate
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -0.58  // Z offset: -below +above  [the nozzle]
//#define Z_PROBE_OFFSET_FROM_EXTRUDER -2.85  // Z offset: -below +above  [the nozzle]

// Certain types of probes need to stay away from edges
#define MIN_PROBE_EDGE 12.5
...
#define NOZZLE_CLEAN_CIRCLE_RADIUS 70
